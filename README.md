...
<p>Как видим, после перезагрузки настройки сохранились.</p>

<p>В результате добились работоспособности приложения с включенным selinux за счет анализа и выявления причины блокировки работы приложения selinux-ом. В данном случае, воспользовавшись утилитой audit2why, мы добились работоспособности приложения, изменив тип контекста безопасности для каталога /etc/named.</p>

<p>Для того, чтобы вернуть правила обратно, на стороне сервера вводим команду:</p>
